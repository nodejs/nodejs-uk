...
Wrapper for instance of [net.Socket](net.html#net_class_net_socket), replaces internal socket read/write routines to perform transparent encryption/decryption of incoming/outgoing data.
